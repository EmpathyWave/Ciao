...
===CafeOwner===
    ...
    =DanniRiccobono0GrandpaGiovanni_
        Your grandfather hasn’t returned to the town in awhile from what I know, I am sure that’s weird for you.
        ->DONE
    =DanniRiccobono0Lucianoss_
    ...
    =GrandpaGiovanni_
        ...
        ->DONE
    =GrandpaGiovanni0Lucianoss_
        There is a picture of him, Lucca, and some other guy in the restaurant! They look like they are having fun hahaha
        ->DONE
    =GrandpaGiovanni0PiccolaPanetteria_
        I don’t know what happened with him and that place, all I heard is that he wanted to leave, it’s not really my story to tell either.
        ->DONE
    =GrandpaGiovanni0UncleLucca_
        I don’t know about what happened with them, it was just difficult for everyone, including the town, but I don’t know, I am still relatively new here.
        ->DONE
    =Lucianoss_
        I love that place. I am always there on the weekends heheh you should check it out!
        ->DONE
    =Lucianoss0PiccolaPanetteria_
        Those two places have been around for such a long time, I think Luciano’s is a family thing, so it’s been around for longer. My café is the newest shop on the block!
        ->DONE
    =Lucianoss0UncleLucca_
        I haven’t seen him in there, but he probably eats their earlier than I do, he closes the bakery before dinner.
        ->DONE
    =PiccolaPanetteria_
    ...
    =PiccolaPanetteria0UncleLucca_
        He has been running that bakery for a long time by himself. I wonder if he misses running it with your grandfather…
        ->DONE
    =UncleLucca_
...
===Bartender===
    ...
    =DanniRiccobono0GrandpaGiovanni_
        ...
        ->DONE
    =DanniRiccobono0Lucianoss_
        You should come by later. We have a good selection of wine.
        ->DONE
    =DanniRiccobono0PiccolaPanetteria_
        You should visit the bakery while you can. I am sure your grandfather told you about it.
        ->DONE
    =DanniRiccobono0UncleLucca_
    ...
    =GrandpaGiovanni_
        ...
        ->DONE
    =GrandpaGiovanni0Lucianoss_
        We have an old picture of your gramps, Lucca, and some guy I never heard about, on our corkboard. It’s an old picture.
        ->DONE
    =GrandpaGiovanni0PiccolaPanetteria_
        Yeah that is a well of drama that I don’t like to be involved in.
        ->DONE
    =GrandpaGiovanni0UncleLucca_
        You are asking the wrong person about that.
        ->DONE
    =Lucianoss_
        I am a bartender here. I am cleaning up before we open for the afternoon. Hopefully I get a different gig soon...que sera, sera.
        ->DONE
    =Lucianoss0PiccolaPanetteria_
        These two places are as old as time, I feel like this trattoria is ready to collapse some days.
        ->DONE
    =Lucianoss0UncleLucca_
        Sometimes your uncle sits at the bar and I serve him some prosecco and he and I just chat, he is a lovely patron.
        ->DONE
    =PiccolaPanetteria_
        It feels like that place is as old as Luciano’s. Oof I love their cannoli, that’s my only weakness. Your uncle knows how to bake.
        ->DONE
    =PiccolaPanetteria0UncleLucca_
        He is a baking legend, that man is amazing, his bakery was my favorite place as a kid. It still is.
        ->DONE
    =UncleLucca_
        He is a really sweet old man, I don’t know him personally that well, but he loves a good white. He is good friends with Emilia Cardello, I see them chatting a lot.
        ->DONE
->END
...
===EmiliaCardello===
    ->DONE
    =Default_
        Ciao ragazza! Ask me anything about the town, I have been around long enough to probably know about it!
        ->DONE
    =DanniRiccobono_
    ...
    =DanniRiccobono0EmiliaCordella_
        ...
        ->DONE
    =DanniRiccobono0GrandpaGiovanni_
        Your grandfather is a very nice man, I am sure he is very happy that you are seeing his hometown!
        ->DONE
    =DanniRiccobono0Lucianoss_
        That trattoria is a staple of this town, you will get the chance to eat there before you leave, I am sure.
        ->DONE
    =DanniRiccobono0PiccolaPanetteria_
    ...
    =EmiliaCordella0UncleLucca_
        ...
        ->DONE
    =GrandpaGiovanni_
        Your grandfather is a great man, tell him to give me a ring I miss talking, we have a lot to catch up on!
        ->DONE
    =GrandpaGiovanni0Lucianoss_
        I remember your grandfather and Lucca, when they were younger, would drink there all night, what a bunch of rascals. There would always been some story the next day hehehe
        ->DONE
    =GrandpaGiovanni0PiccolaPanetteria_
        There is a lot of history of him and the bakery, you are better off talking to Lucca about that. I am sure they miss running it together.
        ->DONE
    =GrandpaGiovanni0UncleLucca_
        Those two have been through a lot, just certain things make it hard to bounce back. I think enough time has passed now since that whole series of events.
        ->DONE
    =Lucianoss_
        It is 'the' trattoria, feels as old as this town. It’s almost a landmark.
        ->DONE
    =Lucianoss0PiccolaPanetteria_
        These two places are the best parts of this town, wine, pasta, bread, and sweets.
        ->DONE
    =Lucianoss0UncleLucca_
        He always tries to get the early bird special, and at this point he is always given an early bird special no matter the time. 
        ->DONE
    =PiccolaPanetteria_
        This bakery is so great, I am worried your uncle is going to shut it down soon, that would be such a tragedy.
        ->DONE
    =PiccolaPanetteria0UncleLucca_
        I really hope that Lucca finds someone to take over the bakery. He is such a hardworking man, he needs a long rest after running it solo for so many years.
        ->DONE
    =UncleLucca_
